      ...
      <div className="container mx-auto px-4 border-t-4 border-black">
        <div className="mb-12">
          <h2 className="text-4xl font-extrabold text-center text-black tracking-tight">
            <p className="text-4xl font-black">Get In Touch</p>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md flex flex-col justify-center">
            <div className="border-b border-gray-200 pb-2 mb-6">
              <h3 className="text-2xl font-bold text-black">
                <p className="text-2xl font-black">Contact Information</p>
              </h3>
            </div>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-[#017979] p-2 rounded-full text-white mr-4 m-3 flex items-center justify-center w-10  h-10 min-w-10">
              ...
              <div className="flex items-start">
                <div className="bg-[#017979] p-2 m-3 rounded-full text-white mr-4 flex items-center justify-center w-10 h-10 min-w-10">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-8 flex justify-center">
              <div className="flex flex-wrap gap-3 justify-center">
                <a href="#" className="m-3 bg-blue-600 hover:bg-blue-700 transition-colors rounded-full w-11 h-11 flex items-center justify-center text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 1.325v21.351c0 .731.593 1.324 1.325 1.324h11.495v-9.294h-3.128v-3.622h3.128v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.795.143v3.24l-1.918.001c-1.504 0-1.795.715-1.795 1.763v2.313h3.587l-.467 3.622h-3.12v9.293h6.116c.73 0 1.323-.593 1.323-1.325v-21.35c0-.732-.593-1.325-1.325-1.325z" />
                  </svg>
                </a>
                <a href="#" className="m-3 bg-blue-400 hover:bg-blue-500 transition-colors rounded-full w-11 h-11 flex items-center justify-center text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 9.99 9.99 0 01-3.127 1.195 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" />
                  </svg>
                </a>
                <a href="#" className="m-3 bg-red-600 hover:bg-red-700 transition-colors rounded-full w-11 h-11 flex items-center justify-center text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" className="m-3 bg-pink-600 hover:bg-pink-700 transition-colors rounded-full w-11 h-11 flex items-center justify-center text-white">
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3 bg-white p-6 rounded-lg shadow-md">
            <div className="border-b border-gray-200 pb-2 mb-6">
              <h3 className="text-2xl font-bold text-black">
                <p className="text-2xl font-black">Send us a message</p>
              </h3>
            </div>
